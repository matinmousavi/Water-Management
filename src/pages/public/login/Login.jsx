...
const Login = () => {
    ...
    const handleDemoUserSelect = mobile => {
        form.setFieldsValue({
            mobile,
            otp: '',
        })
    ...
    const getRoleTitle = role => {
        ...
        if (role === 'irrigator') return 'میرآب'
        if (role === 'landOwner') return 'مالک زمین'
    ...
    return (
        <Flex
            ...
            vertical
            align='center'
            justify={isMobileView ? 'flex-end' : 'center'}
        >
            <Flex
                ...
                >
                    ...
                    >
                        {loginStep === 1 ? (
                            <Flex
                                vertical
                                gap={isMobileView ? 20 : 8}
                            >
                                <Typography.Text
                                    className={`${styles.loginInfo} ${styles.loginInfoRight}`}
                                >
                            ...
                            <Flex vertical gap={32}>
                                <Flex vertical gap={16}>
                                    <Typography.Text
                                        className={`${styles.loginInfo} ${styles.loginInfoCenter}`}
                                    >
                                ...
                                >
                                    ...
                                    0 ? (
                                        ...
                                        >
                                            <Typography.Text
                                                className={
                                                    styles.loginResendText
                                                }
                                            >
                                                کد را دریافت نکرداید؟
                                            </Typography.Text>
