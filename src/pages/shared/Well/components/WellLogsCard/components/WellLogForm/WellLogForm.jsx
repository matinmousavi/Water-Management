...
const WellLogForm = ({ form, lands, onFinish }) => {
          ...
          <Form.Item noStyle shouldUpdate>
            {({ getFieldValue }) =>
              getFieldValue('isStart') ? (
                <Form.Item name='startNotes' label='توضیحات شروع' labelCol={labelCol} wrapperCol={wrapperCol} rules={[{ required: true, message: 'این فیلد الزامی است' }]}>
                  <Input.TextArea rows={3} />
                </Form.Item>
              ) : getFieldValue('isEnd') ? (
                <Form.Item name='endNotes' label='توضیحات پایان' labelCol={labelCol} wrapperCol={wrapperCol} rules={[{ required: true, message: 'این فیلد الزامی است' }]}>
                  <Input.TextArea rows={3} />
                </Form.Item>
              ) : null
            }
